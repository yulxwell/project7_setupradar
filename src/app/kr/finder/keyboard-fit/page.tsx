...
import { ArrowRight, ChevronDown, Info, Keyboard, RotateCcw } from "lucide-react";
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_390px]">
            ...
            <div className="grid gap-3 md:col-span-2 md:grid-cols-2">
              ...
              <div className="rounded-xl border border-[var(--accent)]/35 bg-[var(--accent)]/[0.04] p-3 shadow-sm shadow-[var(--accent)]/5 md:col-span-2">
                <p className="text-[11px] leading-relaxed text-[var(--muted)]">
                  상세 기준은 제품 후보를 더 좁히기 위한 참고 조건입니다. 태블릿/iPad 사용 시 배열·블루투스·거치 환경을 함께 확인해 주세요.
                </p>
              </div>
            </div>
          )}
          ...
          >
            <div>
              ...
              <p className="mt-1 text-[11px] leading-relaxed text-[var(--muted)]">
                필터로 후보를 좁힌 뒤, 키보드 비교에서 배열과 스위치 차이를 함께 살펴보세요.
              </p>
            </div>
        ...
        <aside className="space-y-3 xl:sticky xl:top-20 xl:self-start">
          <div className="rounded-xl border border-[var(--accent)]/35 bg-[var(--accent)]/[0.04] p-3 shadow-sm shadow-[var(--accent)]/5">
            ...
            <p className="mt-1 text-[11px] leading-relaxed text-[var(--accent)] opacity-85">현재 데이터에 있는 조건만 점수화한 참고용 결과입니다.</p>
          </div>
