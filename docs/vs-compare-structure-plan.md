...
- 2026-06-07 Compare Picker Structure Plan 작업에서는 문서화만 진행했고, 이후 Mouse Compare Picker Mock 1에서 `/kr/compare/mouse` route와 기본 A/B 비교표를 추가했다.
- Picker는 추천 점수나 자동 정렬 없이 사용자가 고른 두 제품만 비교한다.
